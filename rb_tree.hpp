...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/02/02 19:10:01 by bchelste          #+#    #+#             */
/*   Updated: 2022/02/19 15:31:02 by bchelste         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
namespace ft
{
	...
	class Node
	{
		public:
			typedef T								data_type;
			typedef std::allocator<data_type>		alloc_type;
			...
			Node(const alloc_type &n_alloc = alloc_type());
			Node(const data_type &data, unsigned int color = 1, const alloc_type &n_alloc = alloc_type());
	...
	template <typename T>
	Node<T>::Node(const alloc_type &n_alloc) : value(NULL), alloc(n_alloc), color(BLACK_NODE), left(NULL), right(NULL), parent(NULL)
	{
		
	}

	template <typename T>
	Node<T>::Node(const data_type &data, unsigned int n_color, const alloc_type &n_alloc) : alloc(n_alloc), color(n_color), left(NULL), right(NULL), parent(NULL)
	{
		this->value = this->alloc.allocate(1);
		this->alloc.construct(this->value, data);
	}

	template <typename T>
	Node<T>::Node(const Node &data)
	{
		*this = data;
	}
	...
	template <typename T>
	Node<T>	&Node<T>::operator=(const Node &data)
	{
		if (this == &data)
			return (*this);
		...
		{
			this->value = this->alloc.allocate(1);
			this->alloc.construct(this->value, *(data.value));
		}
		else
			this->value = NULL;
	...
	class rb_tree
	{
		...
		public:
			...
			rb_tree(const value_compare &n_compare, const alloc_type &n_alloc);
			rb_tree(const rb_tree &data);
			~rb_tree();
			
			rb_tree &operator=(const rb_tree &data);
	...
	rb_tree<T, Compare, Allocator>::rb_tree(const value_compare &n_compare, const alloc_type &n_alloc) : size(0), compare(n_compare), finish(nil_node()), root(this->finish), start(nil_node()), al_node(n_alloc)
	{
		
	}

	template<typename T, typename Compare, typename Allocator>
	rb_tree<T, Compare, Allocator>::rb_tree(const rb_tree &data) : compare(data.compare), finish(nil_node()), start(nil_node()), al_node(data.al_node)
	{
		*this = data;
	}
	...
	template<typename T, typename Compare, typename Allocator>
	rb_tree<T, Compare, Allocator> &rb_tree<T, Compare, Allocator>::operator=(const rb_tree &data)
	{
	...
	template<typename T, typename Compare, typename Allocator>
	typename rb_tree<T, Compare, Allocator>::iterator rb_tree<T, Compare, Allocator>::begin()
	{
		if (this->empty())
	...
	template<typename T, typename Compare, typename Allocator>
	typename rb_tree<T, Compare, Allocator>::const_iterator rb_tree<T, Compare, Allocator>::begin() const
	{
		if (this->empty())
			return (iterator(this->finish));
		return (iterator(this->start->parent));	
	...
	template<typename T, typename Compare, typename Allocator>
	typename rb_tree<T, Compare, Allocator>::iterator rb_tree<T, Compare, Allocator>::end()
	{
		return (iterator(this->finish));
	}

	template<typename T, typename Compare, typename Allocator>
	typename rb_tree<T, Compare, Allocator>::const_iterator rb_tree<T, Compare, Allocator>::end() const
	{
		return (const_iterator(this->finish));
	}

	template<typename T, typename Compare, typename Allocator>
	typename rb_tree<T, Compare, Allocator>::reverse_iterator rb_tree<T, Compare, Allocator>::rbegin()
	{
		return (reverse_iterator(this->end()));
	}

	template<typename T, typename Compare, typename Allocator>
	typename rb_tree<T, Compare, Allocator>::reverse_const_iterator rb_tree<T, Compare, Allocator>::rbegin() const
	{
		return (reverse_const_iterator(this->end()));
	}
	
	template<typename T, typename Compare, typename Allocator>
	typename rb_tree<T, Compare, Allocator>::reverse_iterator rb_tree<T, Compare, Allocator>::rend()
	{
		return (reverse_iterator(this->begin()));
	}
	
	template<typename T, typename Compare, typename Allocator>
	typename rb_tree<T, Compare, Allocator>::reverse_const_iterator rb_tree<T, Compare, Allocator>::rend() const
	{
	...
	template<typename T, typename Compare, typename Allocator>
	bool rb_tree<T, Compare, Allocator>::empty() const
	{
		if (this->size == 0)
			return (true);
		return (false);
	...
	template<typename T, typename Compare, typename Allocator>
	typename rb_tree<T, Compare, Allocator>::size_type rb_tree<T, Compare, Allocator>::max_size() const
	{
		return (this->al_node.max_size());
	}

	template<typename T, typename Compare, typename Allocator>
	typename rb_tree<T, Compare, Allocator>::size_type rb_tree<T, Compare, Allocator>::get_size() const
	{
		return (this->size);
	}
	...
	template<typename T, typename Compare, typename Allocator>
	ft::pair<typename rb_tree<T, Compare, Allocator>::iterator, bool> rb_tree<T, Compare, Allocator>::insert(const value_type &val)
	{
	...
	template<typename T, typename Compare, typename Allocator>
	typename rb_tree<T, Compare, Allocator>::iterator rb_tree<T, Compare, Allocator>::insert(iterator position, const value_type &val)
	{
	...
	template<typename T, typename Compare, typename Allocator>
	template <class InputIterator>
	void rb_tree<T, Compare, Allocator>::insert(InputIterator first, InputIterator last, typename enable_if<!ft::is_integral<InputIterator>::value>::type*)
	{
	...
	template<typename T, typename Compare, typename Allocator>
	void	rb_tree<T, Compare, Allocator>::erase(iterator position)
	{
	...
	template<typename T, typename Compare, typename Allocator>
	typename rb_tree<T, Compare, Allocator>::size_type rb_tree<T, Compare, Allocator>::erase(const value_type &key)
	{
	...
	template<typename T, typename Compare, typename Allocator>
	void rb_tree<T, Compare, Allocator>::erase(iterator first, iterator last)
	{
	...
	template<typename T, typename Compare, typename Allocator>
	void rb_tree<T, Compare, Allocator>::swap(rb_tree &data)
	{
		size_type 	tmp_size;
		pointer		tmp_ptr;
	...
	template<typename T, typename Compare, typename Allocator>
	void rb_tree<T, Compare, Allocator>::clear()
	{
		rb_tree<T,Compare, Allocator> empty_tree(this->compare, this->al_node);
	...
	template<typename T, typename Compare, typename Allocator>
	typename rb_tree<T, Compare, Allocator>::iterator rb_tree<T, Compare, Allocator>::find(const value_type &k)
	{
		pointer tmp;
	...
	template<typename T, typename Compare, typename Allocator>
	typename rb_tree<T, Compare, Allocator>::const_iterator rb_tree<T, Compare, Allocator>::find(const value_type &k) const
	{
		pointer tmp;
	...
	template<typename T, typename Compare, typename Allocator>
	typename rb_tree<T, Compare, Allocator>::size_type		rb_tree<T, Compare, Allocator>::count(const value_type &k) const
	{
		size_type res = 0;
	...
	template<typename T, typename Compare, typename Allocator>
	typename rb_tree<T, Compare, Allocator>::iterator rb_tree<T, Compare, Allocator>::lower_bound(const value_type &k)
	{
	...
	template<typename T, typename Compare, typename Allocator>
	typename rb_tree<T, Compare, Allocator>::const_iterator rb_tree<T, Compare, Allocator>::lower_bound(const value_type &k) const
	{
	...
	template<typename T, typename Compare, typename Allocator>
	typename rb_tree<T, Compare, Allocator>::iterator rb_tree<T, Compare, Allocator>::upper_bound(const value_type &k)
	{
		iterator it_begin = this->begin();
		iterator it_end = this->end();
	...
	template<typename T, typename Compare, typename Allocator>
	typename rb_tree<T, Compare, Allocator>::const_iterator rb_tree<T, Compare, Allocator>::upper_bound(const value_type &k) const
	{
		const_iterator it_begin = this->begin();
		const_iterator it_end = this->end();
	...
	template<typename T, typename Compare, typename Allocator>
	ft::pair<typename rb_tree<T, Compare, Allocator>::iterator, typename rb_tree<T, Compare, Allocator>::iterator> rb_tree<T, Compare, Allocator>::equal_range(const value_type &k)
	{
		return (ft::pair<iterator, iterator>(this->lower_bound(k), this->upper_bound(k)));
	}
	
	template<typename T, typename Compare, typename Allocator>
	ft::pair<typename rb_tree<T, Compare, Allocator>::const_iterator, typename rb_tree<T, Compare, Allocator>::const_iterator> rb_tree<T, Compare, Allocator>::equal_range(const value_type &k) const
	{
	...
	template<typename T, typename Compare, typename Allocator>
	typename rb_tree<T, Compare, Allocator>::pointer rb_tree<T, Compare, Allocator>::nil_node()
	{
	...
	template<typename T, typename Compare, typename Allocator>
	void rb_tree<T, Compare, Allocator>::dealloc_node(pointer x)
	{
		if (x == NULL)
			return;
	...
	template<typename T, typename Compare, typename Allocator>
	typename rb_tree<T, Compare, Allocator>::pointer rb_tree<T, Compare, Allocator>::clone(pointer x)
	{
	...
	template<typename T, typename Compare, typename Allocator>
	typename rb_tree<T, Compare, Allocator>::pointer rb_tree<T, Compare, Allocator>::search_min(pointer x)
	{
		if (x == NULL)
			return (NULL);
	...
	template<typename T, typename Compare, typename Allocator>
	typename rb_tree<T, Compare, Allocator>::pointer rb_tree<T, Compare, Allocator>::search_max(pointer x)
	{
		if (x == NULL)
			return (NULL);
	...
	template<typename T, typename Compare, typename Allocator>
	void rb_tree<T, Compare, Allocator>::set_start()
	{
		if (this->empty())
		{
			return ;
	...
	template<typename T, typename Compare, typename Allocator>
	void rb_tree<T, Compare, Allocator>::set_finish()
	{
		if (this->empty())
		{
			return ;
	...
	template<typename T, typename Compare, typename Allocator>
	typename rb_tree<T, Compare, Allocator>::pointer rb_tree<T, Compare, Allocator>::search_key(const value_type &k) const
	{
		return (this->search_key_from(k, this->root));
	}

	template<typename T, typename Compare, typename Allocator>
	typename rb_tree<T, Compare, Allocator>::pointer rb_tree<T, Compare, Allocator>::search_key_from(const value_type &k, pointer from) const
	{
	...
	template<typename T, typename Compare, typename Allocator>
	void rb_tree<T, Compare, Allocator>::erase_node(const value_type &k)
	{
	...
	template<typename T, typename Compare, typename Allocator>
	void rb_tree<T, Compare, Allocator>::left_rotate(pointer x)
	{
		pointer tmp_parent;
		pointer right_child;
	...
	template<typename T, typename Compare, typename Allocator>
	void rb_tree<T, Compare, Allocator>::right_rotate(pointer x)
	{
		pointer tmp_parent;
		pointer left_child;
	...
	template<typename T, typename Compare, typename Allocator>
	void rb_tree<T, Compare, Allocator>::replacement(pointer r_parent, pointer old_child, pointer new_child)
	{
		if (r_parent == NULL)
			this->root = new_child;
	...
	template<typename T, typename Compare, typename Allocator>
	typename rb_tree<T, Compare, Allocator>::pointer rb_tree<T, Compare, Allocator>::del_node(pointer x)
	{
		if (x->left != NULL)
		{
	...
	template<typename T, typename Compare, typename Allocator>
	void rb_tree<T, Compare, Allocator>::balance_insert(pointer x)
	{
	...
	template<typename T, typename Compare, typename Allocator>
	typename rb_tree<T, Compare, Allocator>::pointer rb_tree<T, Compare, Allocator>::get_brother(pointer x)
	{
		pointer father = x->parent;
	...
	template<typename T, typename Compare, typename Allocator>
	void rb_tree<T, Compare, Allocator>::balance_erase(pointer x)
	{
		if (x == this->root)
		{
			x->color = BLACK_NODE;
